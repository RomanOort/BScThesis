...
\begin{figure}[!htbp]
    \centering
    \subfloat[]{\label{noncoop+:convergence}\includegraphics[scale=.35]{ThesisKI/Images/convergence_dirnoninc.png}}
    
    \begin{minipage}{.45\linewidth}
    \centering
    \subfloat[]{\label{noncoop+:time}\includegraphics[scale=.35]{ThesisKI/Images/time_dirnoninc.png}}
    \end{minipage}%
    \begin{minipage}{.45\linewidth}
    \centering
    \subfloat[]{\label{noncoop+:dist}\includegraphics[scale=.35]{ThesisKI/Images/distance_dirnoninc.png}}
    \end{minipage}\par\medskip
    \centering
    \subfloat[]{\label{noncoop+:std}\includegraphics[scale=.35]{ThesisKI/Images/std_dirnoninc.png}}
...
\begin{figure}[!htbp]
    \centering
    \subfloat[]{\label{noncoop+:convergence}\includegraphics[scale=.35]{ThesisKI/Images/convergence_udirnoninc.png}}
    
    \begin{minipage}{.45\linewidth}
    \centering
    \subfloat[]{\label{noncoop+:time}\includegraphics[scale=.35]{ThesisKI/Images/time_udirnoninc.png}}
    \end{minipage}%
    \begin{minipage}{.45\linewidth}
    \centering
    \subfloat[]{\label{noncoop+:dist}\includegraphics[scale=.35]{ThesisKI/Images/distance_udirnoninc.png}}
    \end{minipage}\par\medskip
    \centering
    \subfloat[]{\label{noncoop+:std}\includegraphics[scale=.35]{ThesisKI/Images/std_udirnoninc.png}}
...
\begin{figure}[!htbp]
    \centering
    \subfloat[]{\label{diff:convergence}\includegraphics[scale=.35]{ThesisKI/Images/convergence3.png}}
    
    \begin{minipage}{.45\linewidth}
    \centering
    \subfloat[]{\label{diff:time}\includegraphics[scale=.35]{ThesisKI/Images/time3.png}}
    \end{minipage}%
    \begin{minipage}{.45\linewidth}
    \centering
    \subfloat[]{\label{diff:dist}\includegraphics[scale=.35]{ThesisKI/Images/distance3.png}}
    \end{minipage}\par\medskip
    \centering
    \subfloat[]{\label{diff:std}\includegraphics[scale=.35]{ThesisKI/Images/std3.png}}
