...
\subsection{Private Belief Parameter Variation}
\begin{figure}[!htbp]
    \centering
    \subfloat[]{\label{p:convergence}\includegraphics[scale=.35]{ThesisKI/Images/convergence_p.png}}
    
    \begin{minipage}{.45\linewidth}
    \centering
    \subfloat[]{\label{p:time}\includegraphics[scale=.35]{ThesisKI/Images/time_p.png}}
    \end{minipage}%
    \begin{minipage}{.45\linewidth}
    \centering
    \subfloat[]{\label{p:dist}\includegraphics[scale=.35]{ThesisKI/Images/distance_p.png}}
    \end{minipage}\par\medskip
    \centering
    \subfloat[]{\label{p:std}\includegraphics[scale=.35]{ThesisKI/Images/std_p.png}}
    
    \caption{Convergence Behaviour, \\ Non-cooperative Network, \\ Single Non-cooperative Agent, \\ Private Belief Parameter Values}
\end{figure}
\end{document}
