...
A function was added that compares the convergence of a network with \emph{two} non-cooperative agents, in an attempt to analyze the convergence of a network with non-cooperative agents present.
